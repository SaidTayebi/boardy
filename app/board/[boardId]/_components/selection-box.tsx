    ...
    <>
      ...
      />
      {
        isShowingHandles && (
          <>
            <rect 
              className="fill-white stroke-1 stroke-blue-500 cursor-nwse-resize"
              style={{
            ...
            />
            <rect 
              className="fill-white stroke-1 stroke-blue-500 cursor-ns-resize"
              style={{
                width: `${HANDLE_WIDTH}px`,
                height: `${HANDLE_WIDTH}px`,
            ...
            />
            <rect 
              className="fill-white stroke-1 stroke-blue-500 cursor-nesw-resize"
              style={{
                width: `${HANDLE_WIDTH}px`,
                height: `${HANDLE_WIDTH}px`,
          ...
          <rect 
            className="fill-white stroke-1 stroke-blue-500 cursor-ew-resize"
            style={{
              width: `${HANDLE_WIDTH}px`,
              height: `${HANDLE_WIDTH}px`,
